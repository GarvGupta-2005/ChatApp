...
const Sidebar = () => {
  ...
  const {messages,users,selectedUser,getUsers,sendMessage,setMessages,setSelectedUser,unseenMessages,setUnseenMessages} = useContext(ChatContext);
      ...
      <div className='pb-5'>
        ...
        <div className='flex justify-between items-center'>
          ...
          <div className='relative py-2 group'>
            ...
            <div className='absolute top-full right-0 z-60 w-32 p-5 rounded-md bg-[#282142] border border-gray-600 text-gray-200 hidden group-hover:block'>
              <p onClick={()=>navigate('/profile')} className='text-sm cursor-pointer'>Edit Profile</p>
              <hr className='my-2 bordet-t border-gray-500' />
